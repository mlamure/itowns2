...
define('Core/Commander/Providers/GeoJSONToThree',[
    ...
    geomFromGeoJSON = function(type, coords) {
        if (type == 'PolyhedralSurface') {
            return geomFromPolyhedralSurface(coords);
        }
        else if (type == 'MultiPolygon') {
            return geomFromPolyhedralSurface(coords); // TODO : check if different process is necessary for multipolygon
        }
