 ...
 * Class: GridBrowseTree
 * Description: GridBrowseTree récupère les nodes visibles à l'intérieur d'un arbre et lance les process sur les nodes visibles.
 */

define('Scene/GridBrowseTree', ['Globe/TileMesh', 'THREE'], function( TileMesh, THREE) {

    function GridBrowseTree(engine) {
        //Constructor
    ...
    GridBrowseTree.prototype.addNodeProcess = function(nodeProcess) {
        this.nodeProcess = nodeProcess;
    };

    GridBrowseTree.prototype.NodeProcess = function() {
        return this.nodeProcess;
    };

    GridBrowseTree.prototype.resetQuadtreeNode = function(node){
     ...
     * @returns {Boolean}
     */
    GridBrowseTree.prototype.processQuadtreeNode = function(node, camera, process, params)
    {
    ...
    GridBrowseTree.prototype.uniformsProcess = function()
    {
    ...
    GridBrowseTree.prototype._selectNode = function(node)
    {
     ...
     * @returns {undefined}
     */
    GridBrowseTree.prototype.browse = function(tree, camera, process, optional, scene) {
        ...
        var tilesCoords = tree.getVisibleTiles(camera, scene);
     ...
     * @returns {undefined}
     */
    /*GridBrowseTree.prototype._browse = function(node, camera, process, optional, clean) {
    ...
    GridBrowseTree.prototype._clean = function(node, level, process, camera) {
     ...
     * @returns {undefined}
     */
    GridBrowseTree.prototype.updateMaterialUniform = function(uniformName, value){
    ...
    GridBrowseTree.prototype.updateNodeMaterial = function(WMTSProvider){
    ...
    GridBrowseTree.prototype.updateLayer = function(layer,camera) {
    ...
    GridBrowseTree.prototype.updateMobileMappingLayer = function(layer,camera) {
